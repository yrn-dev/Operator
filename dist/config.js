...
export function getSelfUpdateUnavailableInstruction(packageName, npmCommand, updatePackageTarget = packageName) {
    ...
    if (method === "bun-binary") {
        return `Download from your configured opr release source`;
    }
...
export function getPackageDir() {
    ...
    const envDir = process.env.OPR_PACKAGE_DIR;
    if (envDir) {
...
const oprConfigName = pkg.oprConfig?.name;
export const PACKAGE_NAME = pkg.name || "opr";
export const APP_NAME = oprConfigName || "opr";
export const APP_TITLE = APP_NAME.toUpperCase();
export const CONFIG_DIR_NAME = pkg.oprConfig?.configDir || ".opr";
export const VERSION = pkg.version || "0.0.0";
// e.g., OPR_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
export const ENV_AGENT_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_DIR`;
export const ENV_SESSION_DIR = `${APP_NAME.toUpperCase()}_CODING_AGENT_SESSION_DIR`;
export function expandTildePath(path) {
    return normalizePath(path);
}
const DEFAULT_SHARE_VIEWER_URL = "https://opr.local/session/";
/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId) {
    const baseUrl = process.env.OPR_SHARE_VIEWER_URL || process.env.OPR_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
    return `${baseUrl}#${gistId}`;
}
// =============================================================================
// User Config Paths (~/.opr/agent/*)
// =============================================================================
/** Get the agent config directory (e.g., ~/.opr/agent/) */
