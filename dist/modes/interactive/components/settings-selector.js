...
const THINKING_DESCRIPTIONS = {
    off: "Reasoning",
    minimal: "Reasoning minimal (~1k tokens)",
    low: "Reasoning low (~2k tokens)",
    medium: "Reasoning medium (~8k tokens)",
    high: "Reasoning high (~16k tokens)",
    xhigh: "Reasoning xhigh (~32k tokens)",
};
        ...
        const items = [
            {
                ...
                label: "External auth usage",
                description: "Warn when external subscription-based auth may incur billed usage",
    ...
    constructor(config, callbacks) {
        ...
        const items = [
            ...
            },
            {
                id: "thinking",
                label: "Reasoning",
                description: "Reasoning depth for reasoning-capable models",
                currentValue: config.thinkingLevel,
                submenu: (currentValue, done) => new SelectSubmenu("Reasoning", "Select reasoning depth for reasoning-capable models", config.availableThinkingLevels.map((level) => ({
                    value: level,
                    label: level,
