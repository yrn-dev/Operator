 ...
 */
import { type ImageContent } from "@yernur/operator-ai/compat";
import { type AgentSessionRuntime } from "../../core/agent-session-runtime.ts";
import { SessionManager } from "../../core/session-manager.ts";
import { type LatestOperatorRelease } from "../../utils/version-check.ts";
...
export interface InteractiveModeOptions {
    ...
    /** Cwd to trust after reload if it gained a .operator directory during this implicitly trusted session. */
...
export declare class InteractiveMode {
    ...
    showNewVersionNotification(release: LatestOperatorRelease): void;
