import { type ThinkingLevel } from "@yernur/operator-agent-core";
import { type Model } from "@yernur/operator-ai/compat";
...
export interface CreateAgentSessionOptions {
    ...
    cwd?: string;
    /** Global config directory. Default: ~/.opr/agent */
    agentDir?: string;
     ...
     *
     * When omitted, operator enables the default built-in tools (read, bash, edit, write)
 ...
 *
 * // With explicit model
 * import { getModel } from '@yernur/operator-ai';
 * const { session } = await createAgentSession({
