    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="opr-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="opr-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'opr-share:v1:sidebar-width';
