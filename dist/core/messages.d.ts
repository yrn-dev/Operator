 ...
 */
import type { AgentMessage } from "@yernur/operator-agent-core";
import type { ImageContent, Message, TextContent } from "@yernur/operator-ai";
...
declare module "@yernur/operator-agent-core" {
