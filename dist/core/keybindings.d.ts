import { type Keybinding, type KeybindingsConfig, type KeyId, KeybindingsManager as TuiKeybindingsManager } from "@yernur/operator-tui";
...
declare module "@yernur/operator-tui" {
