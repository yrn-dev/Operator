 ...
 * Encodes cwd into a safe directory name under ~/.opr/agent/sessions/.
 */
...
export class SessionManager {
     ...
     * @param sessionDir Optional session directory. If omitted, uses default (~/.opr/agent/sessions/<encoded-cwd>/).
     */
