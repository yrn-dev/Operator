...
const OFFICIAL_PACKAGE_NAME = "opr";
const OFFICIAL_APP_NAME = "opr";
const OFFICIAL_CONFIG_DIR_NAME = ".opr";
 ...
 * - this is the official opr distribution
 * - experimental features are enabled (OPR_EXPERIMENTAL=1)
